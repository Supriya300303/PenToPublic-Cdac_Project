...
import { BookOpen, Check, ArrowRight, CreditCard, Shield, Zap, Star, Crown, Users, TrendingUp, Globe, Heart } from 'lucide-react';
...
const LandingPageWithSubscription = () => {
  // Navigation state
  ...
  // Navigation function to simulate router navigation
  ...
  const handleFreeSubscription = async () => {
    setLoading(true);
    try {
      await mockAPI.updateSubscription(navigationData.userId, {
        plan: selectedPlan,
        billingCycle: 'free'
      });
  ...
  const handleSuccessNavigation = () => {
    alert(navigationData.fromRegister ? 'Registration complete! Please log in to access your account.' : 'Redirecting to dashboard...');
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center py-4">
              ...
              <div className="flex items-center space-x-6">
                ...
                <button className="bg-gradient-to-r from-amber-500 to-orange-600 text-white px-6 py-2 rounded-xl font-semibold hover:from-amber-600 hover:to-orange-700 transition-all shadow-lg">
                  Sign Up
                </button>
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl text-gray-600 mb-12 max-w-3xl mx-auto leading-relaxed">
                From passionate readers to published authors - discover, create, and share stories that matter on the world's most vibrant writing platform.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button 
                  onClick={() => handlePlanSelect('reader')}
                  className="px-8 py-4 bg-gradient-to-r from-amber-500 to-orange-600 text-white text-lg font-semibold rounded-2xl hover:from-amber-600 hover:to-orange-700 transition-all duration-200 shadow-2xl hover:shadow-3xl transform hover:scale-105"
                >
                  Start Reading Free
                </button>
                <button 
                  onClick={() => handlePlanSelect('premium')}
                  className="px-8 py-4 bg-white/80 backdrop-blur-sm text-gray-800 text-lg font-semibold rounded-2xl hover:bg-white transition-all duration-200 shadow-xl hover:shadow-2xl border border-amber-200"
                >
                  Explore Premium
                </button>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-4 gap-8 text-center">
              ...
              <div className="space-y-2">
                ...
                <div className="text-gray-600">Stories Loved</div>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Whether you're just starting your reading journey or ready to publish your masterpiece, we have the perfect plan for you.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {Object.entries(plans).map(([planKey, plan]) => {
                ...
                return (
                  <div
                    key={planKey}
                    className={`relative bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 cursor-pointer hover:scale-105 ${
                  ...
                  >
                        ...
                        {planKey === 'reader' ? (
                          ...
                          <div>
                            ...
                            <p className="text-green-600 font-medium text-sm mt-1">
                              Save ₹{plan.originalPrice.monthly - plan.monthlyPrice}!
                            </p>
                          </div>
                        )}
                      </div>
                    ...
                    <button className="w-full py-3 bg-gradient-to-r from-amber-500 to-orange-600 text-white rounded-xl font-semibold hover:from-amber-600 hover:to-orange-700 transition-all duration-200 shadow-lg hover:shadow-xl">
                      Get Started
                    </button>
                  </div>
                );
        ...
        <section className="py-20 bg-gradient-to-r from-amber-500 to-orange-600">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-amber-100 mb-12">
              Join thousands of writers and readers in our thriving community. Your next favorite story is waiting to be discovered.
            </p>
            <button 
              onClick={() => handlePlanSelect('premium')}
              className="px-12 py-4 bg-white text-amber-600 text-lg font-semibold rounded-2xl hover:bg-amber-50 transition-all duration-200 shadow-2xl hover:shadow-3xl transform hover:scale-105"
            >
        ...
        <footer className="bg-gray-900 text-white py-12">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-4 gap-8">
              <div>
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <h3 className="text-xl font-bold">PenToPublic</h3>
                </div>
                <p className="text-gray-400">
                  Empowering writers and readers to create, share, and discover amazing stories.
                </p>
              </div>
              <div>
            ...
            <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
              <p>&copy; 2025 PenToPublic. All rights reserved.</p>
            </div>
          </div>
        </footer>
      </div>
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-100 flex items-center justify-center">
        <div className="max-w-md mx-auto text-center bg-white rounded-2xl p-8 shadow-xl">
          ...
          >
            {navigationData.fromRegister ? 'Continue to Login' : 'Go to Dashboard'}
          </button>
        </div>
      </div>
    );
...
export default LandingPageWithSubscription;